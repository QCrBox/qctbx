...
def test_cli_available_scif(test_id, scif_path, checks):
    ...
    r = subprocess.call(f'python -m qctbx.scaff available --scif_path {scif_path} --block_name {block_name} --output_json {out_json_path}', shell=True)
...
def test_cli_citations(test_id, scif_path):
    ...
    r = subprocess.call(f'python -m qctbx.scaff citation --scif_path {scif_path} --block_name {block_name} --output_json {out_json_path}', shell=True)
...
def test_cli_density_partition(test_id, scif_path, periodic):
    ...
    r = subprocess.call(f'python -m qctbx.scaff density --cif_path {used_cif_path} --scif_path {scif_path} --block_name {block_name} --text_output_path {density_text_path}', shell=True)
    ...
    r = subprocess.call(f'python -m qctbx.scaff partition --cif_path {cif_path} --scif_path {scif_path} --block_name {block_name} --input_wfn_path {density_path} --atom_labels {atom_labels_str} --tsc_path {tsc_path}', shell=True)
...
def test_cli_tsc(test_id, scif_path):
    ...
    r = subprocess.call(f'python -m qctbx.scaff tsc --cif_path {cif_path} --scif_path {scif_path} --block_name {block_name} --tsc_path {tsc_path}', shell=True)
